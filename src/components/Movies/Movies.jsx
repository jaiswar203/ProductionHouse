            ...
            <div className="triflix__movies-carousel">
                ...
                <div className="triflix__movies-carousel__content">
                    <Swiper navigation={true} className="mySwiper" loop speed={700} effect="fade" autoplay>
                        <SwiperSlide>
                            <Image src={"https://res.cloudinary.com/dykwfe4cr/image/upload/v1642081955/TriFlix/1-india-movie-poster-design-bollywood-padmaavat_v5jql1.jpg"} width={1920} height={ winWid < 500 ? 1100 : 800} objectFit="cover" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Image src={"https://res.cloudinary.com/dykwfe4cr/image/upload/v1642081871/TriFlix/ANTIM__HINDI__Listing_Page95_ai69ja.jpg"} width={1920} height={ winWid < 500 ? 1100 : 800} objectFit="cover" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Image src={"https://res.cloudinary.com/dykwfe4cr/image/upload/v1642081871/TriFlix/ANTIM__HINDI__Listing_Page95_ai69ja.jpg"} width={1920} height={ winWid < 500 ? 1100 : 800} objectFit="cover" />
                        </SwiperSlide>
